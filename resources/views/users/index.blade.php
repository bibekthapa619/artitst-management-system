                                        ...
                                        <div class="flex justify-start items-center space-x-4">
                                            <a href="{{ route('users.show', $user['id']) }}"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M1.5 12c2.5 4 6.5 7 10.5 7s8-3 10.5-7c-2.5-4-6.5-7-10.5-7S4 8 1.5 12z" />
                                            ...
                                            <a href="{{ route('users.edit', $user['id']) }}"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M16.414 3a2 2 0 012.828 0l1.758 1.758a2 2 0 010 2.828l-9.9 9.9a2 2 0 01-.707.414l-3.543 1.414a1 1 0 01-1.272-1.272l1.414-3.543a2 2 0 01.414-.707l9.9-9.9zM14 7l3 3m-6.586 6.586L7 17l.707-.707m-1.414-1.414L7 17" />
                                                </svg>
                                            </a>
