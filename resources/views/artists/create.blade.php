...
<div class="container mx-auto">
    <div class="bg-white shadow overflow-hidden sm:rounded-lg p-6">
        ...
        <h1 class="text-2xl font-bold text-indigo-600">Create Artist</h1>

        <form method="POST" action="{{ route('artists.store') }}" class="mt-6">
            @csrf
                ...
                <div id="artist-fields" class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="first_release_year" value="{{ old('first_release_year') }}" class="w-full p-2 border border-gray-300 rounded-lg" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="no_of_albums_released" value="{{ old('no_of_albums_released') }}" class="w-full p-2 border border-gray-300 rounded-lg" required>
