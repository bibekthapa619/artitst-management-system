...
<div class="container mx-auto py-8">
    <div class="bg-white shadow overflow-hidden sm:rounded-lg p-6">
        ...
        <div class="border-b border-gray-200 mb-6">
            <ul class="flex">
                <li class="mr-2">
                    <a href="#user-details" class="inline-block py-2 px-4 text-indigo-600 hover:text-indigo-800 font-semibold" onclick="showTab('user-details')">Artist Details</a>
                </li>
                <li class="mr-2">
                    <a href="#music" class="inline-block py-2 px-4 text-gray-600 hover:text-indigo-800 font-semibold" onclick="showTab('music')">Music</a>
                </li>
            </ul>
        </div>
        ...
        <div id="music" class="hidden tab-content">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700">Music Details</label>
                    <p class="p-2 bg-gray-100 border border-gray-300 rounded-lg">All musics will be displayed here.</p>
                </div>
            </div>
        </div>
